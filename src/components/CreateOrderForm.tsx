...
export const CreateOrderForm: React.FC<CreateOrderFormProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Hiển thị thông báo thành công với mã hóa đơn mới
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 inline-flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-md text-white bg-success-600 hover:bg-success-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
          ...
          <button
            onClick={onCancel}
            className="px-4 py-3 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
          >
            Hủy
          </button>
        </div>
